...
class LoginForm(forms.Form):
    ...
    def clean(self):
        ...
        if username and password:
            ...
            if not user:
                raise forms.ValidationError("Ooops! Something went wrong. You could enter username or password wrong...")
...
class RegisterForm(forms.ModelForm):
    ...
    def clean_password2(self):
        ...
        if password1 and password2 and password1 != password2:
            raise forms.ValidationError("Passwords are not matching! Be careful!")
        return password2
